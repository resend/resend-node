...
import type { ListAttachmentsResponseSuccess } from './interfaces';
  ...
  describe('get', () => {
    describe('when attachment not found', () => {
      it('returns error', async () => {
        ...
        const result = await resend.emails.attachments.get({
    ...
    describe('when attachment found', () => {
      it('returns attachment with download URL', async () => {
        ...
        fetchMock.mockOnceIf(
          'https://api.resend.com/emails/67d9bcdb-5a02-42d7-8da9-0d6feea18cff/attachments/att_123',
      ...
      it('returns inline attachment with download URL', async () => {
        ...
        fetchMock.mockOnceIf(
          'https://api.resend.com/emails/67d9bcdb-5a02-42d7-8da9-0d6feea18cff/attachments/att_456',
          JSON.stringify(apiResponse),
          {
            status: 200,
            headers: {
      ...
      it('handles attachment without optional fields (filename, contentId)', async () => {
        ...
        fetchMock.mockOnceIf(
          'https://api.resend.com/emails/67d9bcdb-5a02-42d7-8da9-0d6feea18cff/attachments/att_789',
          JSON.stringify(apiResponse),
          {
            status: 200,
            headers: {
  ...
  describe('list', () => {
    ...
    describe('when email not found', () => {
      it('returns error', async () => {
        ...
        const result = await resend.emails.attachments.list({
          emailId: '61cda979-919d-4b9d-9638-c148b93ff410',
        });
    ...
    describe('when attachments found', () => {
      it('returns multiple attachments with download URLs', async () => {
        fetchMock.mockOnceIf(
          'https://api.resend.com/emails/67d9bcdb-5a02-42d7-8da9-0d6feea18cff/attachments',
          JSON.stringify(apiResponse),
          {
            status: 200,
            headers: {
    ...
    describe('when pagination options are provided', () => {
      it('calls endpoint passing limit param and return the response', async () => {
        ...
        expect(fetchMock.mock.calls[0][0]).toBe(
          'https://api.resend.com/emails/67d9bcdb-5a02-42d7-8da9-0d6feea18cff/attachments?limit=10',
        );
      });
      ...
      it('calls endpoint passing after param and return the response', async () => {
        ...
        expect(fetchMock.mock.calls[0][0]).toBe(
          'https://api.resend.com/emails/67d9bcdb-5a02-42d7-8da9-0d6feea18cff/attachments?after=cursor123',
        );
      });
      ...
      it('calls endpoint passing before param and return the response', async () => {
        ...
        expect(fetchMock.mock.calls[0][0]).toBe(
          'https://api.resend.com/emails/67d9bcdb-5a02-42d7-8da9-0d6feea18cff/attachments?before=cursor123',
        );
      });
    });
  });
